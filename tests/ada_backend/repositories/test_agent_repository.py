...
def test_fetch_agents_includes_all_versions(
    db_session: Session, test_agent_with_versions, test_organization
):
    """
...
def test_fetch_agents_returns_correct_tag_versions(
    db_session: Session, test_agent_with_versions, test_organization
):
    """
...
def test_fetch_agents_orders_by_creation_date(
...
def test_fetch_agents_filters_by_organization(
    db_session: Session, test_agent_with_versions, test_organization
):
    """
