...
@pytest.fixture
def _mock_llm_completion_service(mock_llm_service):
    """Patch CompletionService so that inline creation returns the shared mock_llm_service."""
    with (
        patch("engine.components.llm_call.CompletionService", return_value=mock_llm_service),
        patch("engine.components.ai_agent.CompletionService", return_value=mock_llm_service),
    ):
        yield mock_llm_service


@pytest.fixture
def llm_agent(mock_trace_manager, mock_llm_service, _mock_llm_completion_service):
...
@pytest.fixture
def react_agent(mock_trace_manager, mock_llm_service, _mock_llm_completion_service):
...
@patch("engine.prometheus_metric.agent_calls")
@patch("engine.prometheus_metric.get_tracing_span")
def test_llm_call_with_template_vars(get_span_mock, agent_calls_mock, llm_agent, mock_llm_service):
...
@patch("engine.prometheus_metric.agent_calls")
@patch("engine.prometheus_metric.get_tracing_span")
def test_llm_call_missing_template_var(get_span_mock, agent_calls_mock, mock_llm_service):
    ...
    with patch("engine.components.llm_call.CompletionService", return_value=mock_llm_service):
        agent = LLMCallAgent(
            trace_manager=tm,
            temperature=1.0,
            llm_api_key=None,
...
@patch("engine.prometheus_metric.agent_calls")
@patch("engine.prometheus_metric.get_tracing_span")
def test_llm_call_wrong_type_template_var(get_span_mock, agent_calls_mock, mock_llm_service):
...
@patch("engine.prometheus_metric.agent_calls")
@patch("engine.prometheus_metric.get_tracing_span")
def test_llm_call_with_input_var(get_span_mock, agent_calls_mock, mock_llm_service):
...
@patch("engine.prometheus_metric.agent_calls")
@patch("engine.prometheus_metric.get_tracing_span")
def test_react_agent_with_template_vars(get_span_mock, agent_calls_mock, react_agent, mock_llm_service):
...
def test_react_agent_wrong_type_template_var(get_span_mock, agent_calls_mock, mock_llm_service, mock_trace_manager):
    ...
    with patch("engine.components.ai_agent.CompletionService", return_value=mock_llm_service):
        react_agent = AIAgent(
            temperature=1.0,
            llm_api_key=None,
            model_id_resolver=lambda _: None,
...
@patch("engine.prometheus_metric.agent_calls")
@patch("engine.prometheus_metric.get_tracing_span")
def test_template_vars_priority(get_span_mock, agent_calls_mock, mock_llm_service):
...
@patch("engine.prometheus_metric.agent_calls")
@patch("engine.prometheus_metric.get_tracing_span")
def test_llm_call_with_file_handling(get_span_mock, agent_calls_mock, mock_llm_service):
...
@patch("engine.prometheus_metric.agent_calls")
@patch("engine.prometheus_metric.get_tracing_span")
def test_llm_call_with_flat_template_vars(get_span_mock, agent_calls_mock, mock_llm_service):
...
@patch("engine.prometheus_metric.agent_calls")
@patch("engine.prometheus_metric.get_tracing_span")
def test_llm_call_template_vars_from_tool_args(get_span_mock, agent_calls_mock, mock_llm_service):
