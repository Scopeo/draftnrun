import pytest
from engine.field_expressions.ast import VarNode, LiteralNode, ConcatNode
...
class TestExtendedFieldExpressions:
    ...
    def test_unparse_external_ref(self):
        ...
        node = VarNode(source="env", key="VAR")
    ...
    def test_evaluate_external_ref(self):
        ...
        expr = VarNode(source="settings", key="theme")
        context = {"settings": {"theme": "dark"}, "secrets": {"token": "123"}}
    ...
    def test_evaluate_missing_source(self):
        ...
        expr = VarNode(source="missing", key="key")
        context = {"settings": {}}
    ...
    def test_evaluate_missing_key(self):
        ...
        expr = VarNode(source="settings", key="missing")
    ...
    def test_get_pure_ref_external(self):
        ...
        expr = VarNode(source="settings", key="key")
