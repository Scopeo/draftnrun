...
@pytest.mark.asyncio
async def test_openai_code_interpreter_tool_with_code_prompt(openai_code_interpreter_tool, mock_code_interpreter_service):
    ...
    result = await openai_code_interpreter_tool._run_without_trace(
        input_payload, code_prompt=code_prompt
    )
...
@pytest.mark.asyncio
async def test_openai_code_interpreter_tool_with_message_content(openai_code_interpreter_tool, mock_code_interpreter_service):
