...
CAPABILITY_MATRIX = {
    ...
    "cerebras": {
        "text": {
            "complete": ["gpt-oss-120b"],
            "complete_structured_pydantic": ["gpt-oss-120b"],
            "complete_structured_json_schema": ["gpt-oss-120b"],
            "function_call": ["gpt-oss-120b"],
            "function_call_structured": ["gpt-oss-120b"],
            "function_call_multi_turn": ["gpt-oss-120b"],
            "function_call_tool_choice_none": ["gpt-oss-120b"],
            "function_call_empty_tools": ["gpt-oss-120b"],
            "function_call_with_system": ["gpt-oss-120b"],
            "function_call_both_tools_and_structured": ["gpt-oss-120b"],
        },
        "vision": {
            "complete": [],
            "complete_structured": [],
    ...
    "anthropic": {
        "text": {
            ...
            "complete_structured_pydantic": ["claude-haiku-4-5"],
            "complete_structured_json_schema": ["claude-haiku-4-5"],
            "function_call": ["claude-haiku-4-5"],
            "function_call_structured": ["claude-haiku-4-5"],
            "function_call_multi_turn": ["claude-haiku-4-5"],
            "function_call_tool_choice_none": ["claude-haiku-4-5"],
            "function_call_empty_tools": ["claude-haiku-4-5"],
            "function_call_with_system": ["claude-haiku-4-5"],
            "function_call_both_tools_and_structured": ["claude-haiku-4-5"],
        },
        "vision": {
            "complete": ["claude-haiku-4-5"],
            "complete_structured": ["claude-haiku-4-5"],
            "function_call_structured": ["claude-haiku-4-5"],
        },
        "specialized": {
            "embedding": [],
