...
from engine.agent.data_structures import AgentPayload, SplitPayload, ToolDescription
...
class Merger(Agent):
    ...
    async def _run_without_io_trace(self, *inputs: AgentPayload | SplitPayload, **kwargs) -> AgentPayload:
        ...
        output_payload = AgentPayload(full_content=merged_content, error=errors, artifacts=merged_artifacts)
