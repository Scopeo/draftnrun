...
from engine.agent.data_structures import ChatMessage, AgentPayload, ToolDescription, ComponentAttributes
...
class SQLTool(Agent):
    ...
    async def _run_without_io_trace(
        ...
        query_str = natural_language_query or agent_input.content
        ...
        return AgentPayload(
            full_content=[ChatMessage(role="assistant", content=output_message)],
