    ...
    return ToolDescription(
        ...
        tool_properties={
            ...
            "filters": {
                "type": "object",
                "description": (
                    "Qdrant filter object. Use top-level 'must' (AND), "
                    "'should' (OR), and/or 'must_not' (NOT) arrays of conditions. "
                    ...
                    '- Range/Datetime range: {"key": "<field>", "range": {"gte": v1, '
                    '"lte": v2}} (dates as ISO 8601 strings)\n'
