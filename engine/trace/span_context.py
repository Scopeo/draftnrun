...
def set_tracing_span(project_id: str, organization_id: str, organization_llm_providers: list[str]) -> None:
    """Set current tracing context with project/org/llm info."""
    params = TracingSpanParams(project_id, organization_id, organization_llm_providers)
