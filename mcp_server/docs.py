...
The If/Else else edge is optional; omit the `order: 1` edge when a false condition should stop \
that branch.
...
- **If/Else branch edges** use `order: 0` for the true route and optional `order: 1` for the else route.
