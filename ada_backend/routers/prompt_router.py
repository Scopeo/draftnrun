...
def pin_prompt(
    ...
    pin_prompt_to_port_service(session, ci_id, port_name, payload.prompt_version_id, graph_runner_id, project_id)
...
def unpin_prompt(
    ...
    unpin_prompt_from_port_service(session, ci_id, port_name, graph_runner_id, project_id)
