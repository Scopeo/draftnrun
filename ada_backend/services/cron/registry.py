...
from ada_backend.services.cron.entries.endpoint_id_tracker import spec as endpoint_id_tracker_spec
...
CRON_REGISTRY: dict[CronEntrypoint, CronEntrySpec] = {
    ...
    CronEntrypoint.ENDPOINT_ID_TRACKER: endpoint_id_tracker_spec,
}
