"""add_quality_assurance_tables_on_qa_schema

Revision ID: 3b2dc6f0d44e
Revises: f9c9976e066e
Create Date: 2025-07-24 21:06:13.343834
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_quality_assurance_version_by_project_id"),
        "version_by_project",
        ["id"],
        unique=False,
        schema="quality_assurance",
    ...
    op.create_index(
        op.f("ix_quality_assurance_version_by_project_project_id"),
        "version_by_project",
        ["project_id"],
        unique=False,
        schema="quality_assurance",
    ...
    op.create_index(
        op.f("ix_quality_assurance_version_output_version_id"),
        "version_output",
        ["version_id"],
        unique=False,
        schema="quality_assurance",
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_quality_assurance_version_output_version_id"), table_name="version_output", schema="quality_assurance"
    )
    op.drop_index(
    ...
    op.drop_index(
        op.f("ix_quality_assurance_version_by_project_project_id"),
        table_name="version_by_project",
        schema="quality_assurance",
    )
    op.drop_index(
        op.f("ix_quality_assurance_version_by_project_id"), table_name="version_by_project", schema="quality_assurance"
    )
