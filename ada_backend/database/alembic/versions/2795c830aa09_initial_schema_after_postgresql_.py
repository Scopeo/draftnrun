...
def upgrade() -> None:
    ...
    create_enum_if_not_exists(op.get_bind(), ["google_drive", "local"], "source_type")
    create_enum_if_not_exists(op.get_bind(), ["graph_runner", "component_instance"], "node_type")
    create_enum_if_not_exists(op.get_bind(), ["pending", "in_progress", "completed", "failed"], "task_status")
    create_enum_if_not_exists(op.get_bind(), ["draft", "production"], "env_type")
    ...
    source_type_enum = postgresql.ENUM("google_drive", "local", name="source_type", create_type=False)
    op.create_table(
        "data_sources",
    ...
    node_type_enum = postgresql.ENUM("graph_runner", "component_instance", name="node_type", create_type=False)
    op.create_table(
        "graph_runner_nodes",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    task_status_enum = postgresql.ENUM(
        "pending", "in_progress", "completed", "failed", name="task_status", create_type=False
    )
    op.create_table(
        "ingestion_tasks",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("project_id", sa.UUID(), nullable=False),
        sa.Column("environment", env_type_enum, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("component_id", sa.UUID(), nullable=False),
        sa.Column("name", sa.String(), nullable=False),
        sa.Column("type", parameter_type_enum, nullable=False),
...
def downgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS ix_api_keys_project_id")
