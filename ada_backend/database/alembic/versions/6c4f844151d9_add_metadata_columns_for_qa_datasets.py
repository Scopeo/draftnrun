...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_quality_assurance_qa_metadata_dataset_id'), 'qa_metadata', ['dataset_id'], unique=False, schema='quality_assurance')
    op.create_index(op.f('ix_quality_assurance_qa_metadata_id'), 'qa_metadata', ['id'], unique=False, schema='quality_assurance')
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_quality_assurance_qa_metadata_id'), table_name='qa_metadata', schema='quality_assurance')
    op.drop_index(op.f('ix_quality_assurance_qa_metadata_dataset_id'), table_name='qa_metadata', schema='quality_assurance')
