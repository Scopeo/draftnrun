"""add metadata table for qa datasets custom columns

Revision ID: 06768bcdd116
Revises: 7f3a9c2d1e5b
Create Date: 2026-02-02 10:13:36.793726
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_quality_assurance_qa_dataset_metadata_dataset_id"),
        "qa_dataset_metadata",
        ["dataset_id"],
        unique=False,
        schema="quality_assurance",
    ...
    op.create_index(
        op.f("ix_quality_assurance_qa_dataset_metadata_id"),
        "qa_dataset_metadata",
        ["id"],
        unique=False,
        schema="quality_assurance",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_quality_assurance_qa_dataset_metadata_id"),
        table_name="qa_dataset_metadata",
        schema="quality_assurance",
    )
    op.drop_index(
        op.f("ix_quality_assurance_qa_dataset_metadata_dataset_id"),
