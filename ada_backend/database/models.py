...
class OAuthConnection(Base):
    ...
    This is completely parallel to Integration + SecretIntegration + IntegrationComponentInstanceRelationship system.
    Connections are scoped to organizations (org-wide, shared across projects).
    """
    ...
    def __repr__(self) -> str:
        return (
            f"OAuthConnection(id={self.id}, organization_id={self.organization_id}, "
...
class PromptVersion(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("prompt_id", "id", name="uq_prompt_version_promptid_id"),
    )
...
class PromptSection(Base):
    ...
    section_prompt_version_id = mapped_column(UUID(as_uuid=True), nullable=False)
