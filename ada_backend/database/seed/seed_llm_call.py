    ...
    upsert_components_parameter_definitions(
        ...
        component_parameter_definitions=[
            db.ComponentParameterDefinition(
                ...
                deprecated=True,
                deprecation_message=(
                    "This parameter is deprecated. Please use the 'prompt_template' input field instead. "
                    "Inputs support field expressions with '@' tags to reference outputs from other components, "
                    "and you can copy your prompt into the input field - it will keep working and you'll also "
                    "be able to use '@' to tag outputs from other components."
                ),
            ),
            db.ComponentParameterDefinition(
            ...
            db.ComponentParameterDefinition(
                ...
                deprecated=True,
                deprecation_message=(
                    "This parameter is deprecated. Please use the 'output_format' input field instead. "
                    "Inputs support field expressions with '@' tags to reference outputs from other components."
                ),
            ),
            *build_completion_service_config_definitions(
