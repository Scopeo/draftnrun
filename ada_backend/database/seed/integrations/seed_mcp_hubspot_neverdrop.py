...
def seed_mcp_hubspot_neverdrop_components(session: Session):
    ...
    upsert_components(session, [hubspot_neverdrop_mcp_tool_component])

    hubspot_neverdrop_mcp_tool_version = db.ComponentVersion(
        id=COMPONENT_VERSION_UUIDS["hubspot_neverdrop_mcp_tool"],
    ...
    upsert_release_stage_to_current_version_mapping(
        session=session,
        component_id=hubspot_neverdrop_mcp_tool_version.component_id,
        release_stage=hubspot_neverdrop_mcp_tool_version.release_stage,
        component_version_id=hubspot_neverdrop_mcp_tool_version.id,
    )

    upsert_component_categories(
        session=session,
        component_id=hubspot_neverdrop_mcp_tool_component.id,
