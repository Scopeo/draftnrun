...
COMPONENT_UUIDS: dict[str, UUID] = {
    ...
    "gmail_neverdrop_sender": UUID("77767a09-724c-482e-82cc-84c911ab1334"),
    ...
    "hubspot_owner_tool": UUID("3fa95976-96f0-44eb-9e82-6b169923d522"),
    "google_calendar_mcp_tool": UUID("a2b3c4d5-e6f7-4a8b-9c0d-1e2f3a4b5c6d"),
    "google_calendar_neverdrop_mcp_tool": UUID("25b70215-487f-4370-8735-3319aa5647a6"),
    "google_contacts_neverdrop_mcp_tool": UUID("e83daffe-1096-493a-b220-b7bea3c0ddf1"),
    "notion_neverdrop_mcp_tool": UUID("d968b7b8-d181-403c-8a8e-b84901bcb1c0"),
...
COMPONENT_VERSION_UUIDS: dict[str, UUID] = {
    "synthesizer": UUID("6f790dd1-06f6-4489-a655-1a618763a114"),
    "retriever": UUID("8baf68a9-1671-4ed5-8374-6ec218f5d9a6"),
    "retriever_v2": UUID("c9643d25-1ba5-41c4-8b95-5caff0be31b8"),
    "cohere_reranker": UUID("dfdc8b87-610f-4ce0-8cf1-276e80bec32b"),
    "formatter": UUID("079512c6-28e2-455f-af2c-f196015534bd"),
    "vocabulary_search": UUID("323cfc43-76d9-4ae1-b950-2791faf798c2"),
    "rag_agent": UUID("fe26eac8-61c6-4158-a571-61fd680676c8"),
    ...
    "rag_agent_v4": UUID("a8b768b3-c436-4ffe-9388-528d55a578e6"),
    "base_ai_agent": UUID("22292e7f-a3ba-4c63-a4c7-dd5c0c75cdaa"),
    "api_call_tool": UUID("674b8c1d-0cc6-4887-be92-e3a2906830ed"),
    "web_search_openai_agent": UUID("d6020df0-a7e0-4d82-b731-0a653beef2e6"),
    ...
    "retriever_tool_v2": UUID("c0beef96-ae63-4f2a-afb0-e73bc53d1761"),
    "pdf_generation": UUID("428baac0-0c5f-4374-b2de-8075218082b4"),
    "project_reference": UUID("4c8f9e2d-1a3b-4567-8901-234567890abc"),
    "chunk_processor": UUID("5d9f0f3e-2b4c-5678-9012-345678901bcd"),
    "docx_generation": UUID("b5195a0f-94f5-4f5c-8804-32dd19b16833"),
    ...
    "hubspot_owner_tool": UUID("796b9a9a-f4bb-474a-9658-aa2f05ec0eac"),
    "google_calendar_mcp_tool": UUID("b3c4d5e6-f7a8-4b9c-0d1e-2f3a4b5c6d7e"),
    "google_calendar_neverdrop_mcp_tool": UUID("a8e43d97-f884-4817-a9fc-4043d5097693"),
    "google_contacts_neverdrop_mcp_tool": UUID("d82467b3-cf88-4d5c-a7d2-9e0eafd28b9e"),
    "notion_neverdrop_mcp_tool": UUID("b17e81cd-a2f1-478e-9d21-89f15c4cfe4b"),
