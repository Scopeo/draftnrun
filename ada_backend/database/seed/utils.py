                ...
                db.ComponentParameterDefinition(
                    ...
                    ui_component_properties=UIComponentProperties(
                        options=[
                            ...
                            # Google (Gemini)
                            SelectOption(value="google:gemini-2.5-pro", label="Gemini 2.5 Pro"),
                            SelectOption(value="google:gemini-2.0-pro", label="Gemini 2.0 Pro"),
                            SelectOption(value="google:gemini-2.5-flash", label="Gemini 2.5 Flash"),
