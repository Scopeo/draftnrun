...
from engine.agent.tools.terminal_command_e2b_tool import E2B_TERMINAL_COMMAND_TOOL_DESCRIPTION
...
TOOL_DESCRIPTION_UUIDS = {
    ...
    "terminal_command_e2b_tool_description": UUID("e2b11112-2222-3333-4444-555555555555"),
}
...
def seed_tool_description(session: Session):
    ...
    terminal_command_e2b_tool_description = db.ToolDescription(
        id=TOOL_DESCRIPTION_UUIDS["terminal_command_e2b_tool_description"],
        **E2B_TERMINAL_COMMAND_TOOL_DESCRIPTION.model_dump(),
    )
    upsert_tool_descriptions(
        ...
        tool_descriptions=[
            ...
            terminal_command_e2b_tool_description,
        ],
    )
