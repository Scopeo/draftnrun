...
from engine.agent.tools.mcp_client_tool import MCP_CLIENT_TOOL_DESCRIPTION
...
TOOL_DESCRIPTION_UUIDS = {
    ...
    "mcp_client_tool_description": UUID("e2b44444-5555-6666-7777-888888888888"),
}
...
def seed_tool_description(session: Session):
    ...
    mcp_client_tool_description = db.ToolDescription(
        id=TOOL_DESCRIPTION_UUIDS["mcp_client_tool_description"],
        **MCP_CLIENT_TOOL_DESCRIPTION.model_dump(),
    )
